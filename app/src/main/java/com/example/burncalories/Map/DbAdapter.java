...
public class DbAdapter {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        public DatabaseHelper(Context context) {
            super(context, "databases.db", null, DATABASE_VERSION);
        }
...
//        String[] selectionArgs = new String[]{date};
        ...
        while (cursor.moveToNext()) {
            ...
            String lines = cursor.getString(cursor
                    .getColumnIndex(DbAdapter.KEY_LINE));
            record.setPathline(Util.parseLocations(lines));
            record.setStartpoint(Util.parseLocation(cursor
                    .getString(cursor
                            .getColumnIndex(DbAdapter.KEY_STRAT))));
            record.setEndpoint(Util.parseLocation(cursor
                    .getString(cursor
                            .getColumnIndex(DbAdapter.KEY_END))));
            if (Util.parseTimeToDate(record.getDate()).equals(date)){
                allRecord.add(record);
            }
